        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="signup.php" method="POST" autocomplete="">
                    <h2 class="text-center">Register Your Valid Account</h2>
                    <p class="text-center">Input your Valid Information</p>
                    ...
                    <div class="link login-link text-center">Already Registered? <a href="login.php">Login here</a></div>
                </form>
            </div>
        </div>
    </div>
